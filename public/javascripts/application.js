...
var questions=[
    ...
    {
		file: "acertijo26/acertijo26.ggb",
		answer: "6493" ,
		kind: "geogebra",
        text: "Utiliza los deslizadores para colocar las cuatro piezas de colores en el cuadrado de forma que no se solapen"
	},
    {
		file: "acertijo27/acertijo27.ggb",
		answer: "3857" ,
		kind: "geogebra",
        text: "En la figura tienes cuatro 'eles' de diferentes colores, pero algunas de ellas no se ven completas. Utiliza los deslizadores para girarlas hasta que se vean completamente las cuatro"
	},
    {
		file: "acertijo28/acertijo28.png",
		answer: "5" ,
		kind: "image",
        text: "¿Cuál es el mínimo número veces que hay pulsar las teclas para obtener el número 16 cuando está recién encendida?"
	},
    {
		file: "acertijo29/acertijo29.png",
		answer: "5" ,
		kind: "image",
        text: "¿Cuál es la cifra de las unidades del número de granos de trigo pedidos?"
	},
  {
		file: "acertijo30/acertijo30.ggb",
		answer: "2468" ,
		kind: "geogebra",
        text: "Completa el cuadrado con números consecutivos que se conecten de forma horizantal, vertical o diagonal"
	}
	/*,
    {
